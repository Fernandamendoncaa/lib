...
<div class="fieldcontain ${hasErrors(bean: locacaoLivroInstance, field: 'cliente', 'error')} required">
	...
	<g:select id="cliente" name="cliente.id" from="${br.com.intersistemas.biblioteca.Cliente.list()}" optionKey="id" required="" value="${locacaoLivroInstance?.cliente?.id}" class="many-to-one"/>
